...
correct_result2 <- data.table::data.table(
  estimate = c(
    0.9999999999970993, 0.05319649369906052, 0.49990544723368685,
    0.0787869281228262, 0.08074602166297257
  ),
  se = c(
    0.10086223614774092, 0.019166951280211203, 0.05923473568223756,
    0.009431254804628527, 0.006225582608442144
  ),
  lower = c(
    0.8023100171475271, 0.015629269189846556, 0.3838053652965012,
    0.060301668705754284, 0.06854387975042596
  ),
  upper = c(
    1.1976899828466716, 0.09076371820827449, 0.6160055291708725,
    0.09727218753989811, 0.09294816357551917
  ),
  ice_ipcw_estimate = NA,
  ipw = c(
    0.04379417325098416, 0.05003478414183253, 0.0904672186367006,
